...
export default class App extends React.Component {
  ...
  winGame = () => {
    if (
      ...
      this.setState({
        winMessage: (itemArray[0] ? "Cross" : "Circle").concat("-Winner-winner Chicken-Dinner")
      });
      Alert.alert("Game Over",this.state.winMessage,this.resetGame);
    } else if (
      itemArray[3] !== "empty" &&
      ...
      this.setState({
        winMessage: (itemArray[6] ? "Cross" : "Circle").concat("-Winner-winner Chicken-Dinner")
      });
      Alert.alert("Game Over",this.state.winMessage,this.resetGame);
    } else if (
      itemArray[0] !== "empty" &&
      ...
      this.setState({
        winMessage: (itemArray[1] ? "Cross" : "Circle").concat("-Winner-winner Chicken-Dinner")
      });
      Alert.alert("Game Over",this.state.winMessage,this.resetGame);
    } else if (
      itemArray[2] !== "empty" &&
      ...
      this.setState({
        winMessage: (itemArray[2] ? "Cross" : "Circle").concat("-Winner-winner Chicken-Dinner")
      });
      Alert.alert("Game Over",this.state.winMessage,this.resetGame);
    } else if (
      itemArray[0] !== "empty" &&
